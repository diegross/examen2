...
/**
 * REST controller for managing {@link com.cenfotec.examen2.domain.Profesor}.
 */
@RestController
@RequestMapping("/api")
public class ProfesorResource {
    ...
    public ResponseEntity<Profesor> updateProfesor(@RequestBody Profesor profesor) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, profesor.getId().toString()))
            .body(result);
    }
