...
public class Profesor implements Serializable {
    ...
    public Profesor genero(String genero) {
        this.genero = genero;
        return this;
    }
    ...
    public Profesor fechaNacimiento(LocalDate fechaNacimiento) {
    ...
    public Profesor fechaContratacion(LocalDate fechaContratacion) {
